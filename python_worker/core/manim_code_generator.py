...
def generate_manim_code(scene_text, scene_id, duration, simple=False):
    ...
    if not simple:
        ...
        2. Layout:
           ...
           - Also to avoid, the text overlapping with animations and maths formulas generated by Manim put the animations, images and maths formulas on the left side of the screen and text on the right side of the image.
